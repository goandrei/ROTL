...
public final class Settings extends JPanel implements MenuOption {
	...
	public void paintComponent(Graphics g) {
		...
		if (!sounds.isMenuMusicMuted())
			g.drawImage(volumeIcon, volumeIconPosX.get(0), volumeIconPosY.get(0), volumeIconDimensionsX,
					volumeIconDimensionsY, this);
		else
			g.drawImage(muteIcon, volumeIconPosX.get(0), volumeIconPosY.get(0), volumeIconDimensionsX,
					volumeIconDimensionsY, this);

		if (!sounds.isGameMusicMuted())
			g.drawImage(volumeIcon, volumeIconPosX.get(1), volumeIconPosY.get(1), volumeIconDimensionsX,
					volumeIconDimensionsY, this);
		else
			g.drawImage(muteIcon, volumeIconPosX.get(1), volumeIconPosY.get(1), volumeIconDimensionsX,
					volumeIconDimensionsY, this);

		if (!sounds.isBattleMusicMuted())
			g.drawImage(volumeIcon, volumeIconPosX.get(2) + 15, volumeIconPosY.get(2), volumeIconDimensionsX,
					volumeIconDimensionsY, this);
		else
			g.drawImage(muteIcon, volumeIconPosX.get(2) + 15, volumeIconPosY.get(2), volumeIconDimensionsX,
					volumeIconDimensionsY, this);
		...
		addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (volumeIcon != null && muteIcon != null) {
					...
					final Rectangle bounds0 = new Rectangle(volumeIconPosX.get(0), volumeIconPosY.get(0),
							volumeIconDimensionsX, volumeIconDimensionsY);

					final Rectangle bounds1 = new Rectangle(volumeIconPosX.get(1), volumeIconPosY.get(1),
							volumeIconDimensionsX, volumeIconDimensionsY);

					final Rectangle bounds2 = new Rectangle(volumeIconPosX.get(2), volumeIconPosY.get(2),
							volumeIconDimensionsX, volumeIconDimensionsY);
